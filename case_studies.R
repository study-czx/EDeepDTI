All_scores = read.csv("D:/Users/czx/PycharmProjects/2-Experiment/All_scores_10fold.csv",header= T)
Drug_id = read.csv("D:/Users/czx/PycharmProjects/1-1HGDTI-code/DrugBank dataset/DTI-benchmark_set/Drug_1409.csv",header= T)
Protein_id = read.csv("D:/Users/czx/PycharmProjects/1-1HGDTI-code/DrugBank dataset/DTI-benchmark_set/Protein_1648.csv",header= T)
know_DTI = read.csv("D:/Users/czx/PycharmProjects/1-1HGDTI-code/DrugBank dataset/DTI-benchmark_set/DTI_8020.csv",header= T)
negative_samples = read.csv("D:/Users/czx/PycharmProjects/1-1HGDTI-code/DrugBank dataset/negative samples/neg_DTI-net_8020.csv",header= T)
...
write.csv(my_predict_score,"D:/Users/czx/PycharmProjects/2-Experiment/Predict_scores.csv",,row.names = F)
