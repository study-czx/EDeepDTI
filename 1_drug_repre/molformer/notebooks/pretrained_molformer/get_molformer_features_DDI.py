...
for type in types:
    ...
    smiles_list = pd.read_csv('../../data/DDI_dataset/drug_list_' + type + '.csv')
    smiles_name = 'smiles'
    ...
    output_path1 = '../../data/DDI_dataset/' + type + '/Molformer.csv'
    output_path2 = '../../data/DDI_dataset/' + type + '/Molformer_max.csv'
