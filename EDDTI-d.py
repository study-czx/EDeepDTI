...
datasets = ["DTI-net dataset/"]
# datasets = ["DTI_rand_8207/"]
...
for dataset in datasets:
    for type in types:
        ...
        for k in range(5):
            ...
            train_P = np.loadtxt(dataset + seed_type + "/" + type + "/train_P.csv", dtype=str, delimiter=",", skiprows=1)
            ...
            train_N = np.loadtxt(dataset + seed_type + "/" + type + "/train_N.csv", dtype=str, delimiter=",", skiprows=1)
            ...
            for epoch in range(num_epoches):
                ...
                print(
                    'epoch:{},Train Loss: {:.4f},Dev Auc: {:.4f}, Test Acc: {:.4f},Test Auc: {:.4f},TestAUPR: {:.4f}'
                        .format(epoch, final_train_losses, final_dev_auc, final_test_acc, final_test_auc, final_test_aupr))
