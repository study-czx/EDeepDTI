...
<p align="center">
  <h3 align="center" style="font-size: 30px;">EDeepDTI：A scalable and robust ensemble deep learning method for predicting drug-target interactions</h3>
...
- [The environment of EDeepDTI](#The environment of EDeepDTI)
- [Usage](#Usage)
...
###  Process of datasets (datasets_DTI/)
